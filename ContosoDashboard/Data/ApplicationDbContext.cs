...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DocumentShare>()
            ...
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<DocumentShare>()
            .HasOne(s => s.GrantedByUser)
            .WithMany()
            .HasForeignKey(s => s.GrantedByUserId)
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<DocumentShare>()
            .HasIndex(s => new { s.DocumentId, s.RecipientUserId, s.RecipientTeamKey });
        ...
        modelBuilder.Entity<DocumentActivity>()
            ...
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<DocumentActivity>()
            .HasIndex(a => new { a.DocumentId, a.OccurredDate });
        modelBuilder.Entity<DocumentActivity>()
            .HasIndex(a => a.RetainUntil);
